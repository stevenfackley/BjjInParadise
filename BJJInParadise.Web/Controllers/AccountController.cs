...
namespace BJJInParadise.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        private void AddAdminUsers()
        {
            ...
            if (!RoleManager.RoleExists(UserConsts.ADMIN_ROLE))
            {
                RoleManager.Create(new IdentityRole(UserConsts.ADMIN_ROLE));

            }
            if (!RoleManager.RoleExists(UserConsts.USER_ROLE))
            {
                RoleManager.Create(new IdentityRole(UserConsts.USER_ROLE));
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    AddUserToRole(user);
                    await _accountService.AddAsync(new User
                    {
